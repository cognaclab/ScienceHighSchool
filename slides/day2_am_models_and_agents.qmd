...
| | |
|---|---|
| **Today AM** | learn R, build toy worlds (coins, random walks) |
| **Today PM** | build an agent that *learns* |
| **Tomorrow AM** | let agents *copy each other* — societies! |
| **Tomorrow PM** | your own research project |
| **Day 4** | you present — like real scientists |
